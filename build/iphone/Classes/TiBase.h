...
// in simulator we redefine to format for HowIsTheWeather Developer console
...
{\
	NSString * exceptionName = [@"org.howistheweather." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.howistheweather";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIHowIsTheWeatherNativeItemNone = -1, 
	UIHowIsTheWeatherNativeItemSpinner = -2,
	UIHowIsTheWeatherNativeItemProgressBar = -3,
	
	UIHowIsTheWeatherNativeItemSlider = -4,
	UIHowIsTheWeatherNativeItemSwitch = -5,
	UIHowIsTheWeatherNativeItemMultiButton = -6,
	UIHowIsTheWeatherNativeItemSegmented = -7,
	
	UIHowIsTheWeatherNativeItemTextView = -8,
	UIHowIsTheWeatherNativeItemTextField = -9,
	UIHowIsTheWeatherNativeItemSearchBar = -10,
	
	UIHowIsTheWeatherNativeItemPicker = -11,
	UIHowIsTheWeatherNativeItemDatePicker = -12,
	
	UIHowIsTheWeatherNativeItemInfoLight = -13,
	UIHowIsTheWeatherNativeItemInfoDark = -14,
	
	UIHowIsTheWeatherNativeItemDisclosure = -15,
	
	UIHowIsTheWeatherNativeItemContactAdd = -16
};
